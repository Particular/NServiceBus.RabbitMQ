namespace NServiceBus.Transport.RabbitMQ.CommandLine
{
    ...
    class DelaysMigrateCommand
    {
        ...
        static IRoutingTopology GetRoutingTopology(Topology routingTopology, bool useDurableEntities) => routingTopology switch
        {
            ...
            Topology.Direct => new DirectRoutingTopology(new DirectRoutingTopology.Conventions(() => "amq.topic", DefaultRoutingKeyConvention.GenerateRoutingKey), useDurableEntities, QueueType.Quorum),
