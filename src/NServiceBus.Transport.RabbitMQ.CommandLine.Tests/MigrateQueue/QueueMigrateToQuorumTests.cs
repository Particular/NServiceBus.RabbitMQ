namespace NServiceBus.Transport.RabbitMQ.CommandLine.Tests.MigrateEndpoint
{
    ...
    public class QueueMigrateToQuorumTests
    {
        ...
        public async Task SetUp()
        {
            ...
            var connectionFactory = new RabbitMQ.ConnectionFactory("unit-tests", connectionConfiguration, null, true, false, null, TimeSpan.FromSeconds(30), TimeSpan.FromSeconds(30), null);
        ...
        Task ExecuteMigration(string endpointName)
        {
            ...
            var migrationCommand = new QueueMigrateCommand(endpointName, brokerConnection, output);
