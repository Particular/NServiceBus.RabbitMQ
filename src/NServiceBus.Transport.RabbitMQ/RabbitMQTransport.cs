...
namespace NServiceBus
{
    ...
    public class RabbitMQTransport : TransportDefinition
    {
        ...
        /// <summary>
        /// The strategy for deriving the message ID from the raw RabbitMQ message. Override in case of native integration when the sender
        ...
        Task SetupInfrastructure(string[] receivingQueues, string[] sendingQueues, ConnectionFactory connectionFactory)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                foreach (var receivingAddress in receivingQueues)
                {
