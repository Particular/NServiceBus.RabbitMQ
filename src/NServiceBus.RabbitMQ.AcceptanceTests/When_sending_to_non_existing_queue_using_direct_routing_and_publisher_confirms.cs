namespace NServiceBus.Transport.RabbitMQ.AcceptanceTests
{
    ...
    public class When_sending_to_non_existing_queue_using_direct_routing_and_publisher_confirms : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class Sender : EndpointConfigurationBuilder
        {
            public Sender()
            {
                EndpointSetup<DefaultServer>(c => c.UseTransport<RabbitMQTransport>()
                    .UseDirectRoutingTopology().UsePublisherConfirms(true));
            }
        }
