...
namespace System.Threading.Tasks.Dataflow
{
    ...
    {
        /// <summary>
        /// Gets or sets whether the linked target will have completion and faulting notification propagated to it
        /// automatically.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the link should be appended to the source’s list of links, or whether it should be
        /// prepended.
        /// </summary>
        public bool Append
        {
        ...
        int _maxNumberOfMessages = Unbounded;
        ...
        /// <remarks>
        /// Do not change the values of this instance.  It is shared by all of our blocks that need to unlink after one message has
        /// been consumed.
        /// </remarks>
