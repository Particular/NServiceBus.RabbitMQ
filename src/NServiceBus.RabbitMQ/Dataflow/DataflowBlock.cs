...
namespace System.Threading.Tasks.Dataflow
{
    ...
    static class DataflowBlock
    {
        ...
        /// <summary>
        /// Links the <see cref="ISourceBlock{TOutput}" /> to the specified <see cref="ITargetBlock{TOutput}" /> using the
        /// specified filter.
        /// </summary>
        /// <param name="source">The source from which to link.</param>
        /// <param name="target">The <see cref="ITargetBlock{TOutput}" /> to which to connect the source.</param>
        ...
        sealed class FilteredLinkPropagator<T> : IPropagatorBlock<T, T>, IDebuggerDisplay
        {
            ...
            DataflowMessageStatus ITargetBlock<T>.OfferMessage(DataflowMessageHeader messageHeader, T messageValue, ISourceBlock<T> source, bool consumeToAccept)
            {
                ...
                {
                    throw new ArgumentException("messageHeader");
                }
                if (source == null)
                {
                    throw new ArgumentNullException("source");
            ...
            sealed class PredicateContextState
            {
        ...
        /// from the call the resulting <see cref="System.Threading.Tasks.Task{Boolean}" /> will be completed and its
        /// <see cref="System.Threading.Tasks.Task{Boolean}.Result">Result</see>
        /// property will return true.  If the target declines the offered element during the call, upon return from the call the
        /// resulting <see cref="System.Threading.Tasks.Task{Boolean}" /> will
        /// be completed and its <see cref="System.Threading.Tasks.Task{Boolean}.Result">Result</see> property will return false.
        /// If the target
        /// postpones the offered element, the element will be buffered until such time that the target consumes or releases it, at
        /// which
        /// point the Task will complete, with its <see cref="System.Threading.Tasks.Task{Boolean}.Result" /> indicating whether
        /// the message was consumed.  If the target
        ...
        public static Task<bool> SendAsync<TInput>(this ITargetBlock<TInput> target, TInput item, CancellationToken cancellationToken)
        {
            ...
            try
            {
                switch (target.OfferMessage(Common.SingleMessageHeader, item, null, false))
                {
        ...
        sealed class SendAsyncSource<TOutput> : TaskCompletionSource<bool>, ISourceBlock<TOutput>, IDebuggerDisplay
        {
            ...
            TOutput ISourceBlock<TOutput>.ConsumeMessage(DataflowMessageHeader messageHeader, ITargetBlock<TOutput> target, out bool messageConsumed)
            {
                ...
                var validMessage = messageHeader.Id == Common.SINGLE_MESSAGE_ID;
            ...
            internal void OfferToTarget()
            {
                try
                {
                    ...
                    switch (_target.OfferMessage(
                        Common.SingleMessageHeader, _messageValue, this, consumeToAccept))
                    {
            ...
            int _cancellationState; // one of the CANCELLATION_STATE_* constant values, defaulting to NONE
        ...
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task{TOutput}" /> that represents the asynchronous receive operation.  When an item
        /// is successfully received from the source,
        /// the returned task will be completed and its <see cref="System.Threading.Tasks.Task{TOutput}.Result">Result</see> will
        /// return the received item.  If an item cannot be retrieved,
        ...
        /// The <see cref="System.Threading.CancellationToken" /> which may be used to cancel the
        /// receive operation.
        /// </param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task{TOutput}" /> that represents the asynchronous receive operation.  When an item
        ...
        /// timeout is a negative number other than -1 milliseconds, which represents an infinite time-out -or- timeout is greater
        /// than <see cref="System.Int32.MaxValue" />.
        /// </exception>
        public static Task<TOutput> ReceiveAsync<TOutput>(
        ...
        /// the returned task will be completed and its <see cref="System.Threading.Tasks.Task{TOutput}.Result">Result</see> will
        /// return the received item.  If an item cannot be retrieved,
        /// either because the timeout expires, cancellation is requested, or the source is empty and completed, the returned task
        /// will be canceled.
        /// </returns>
        /// <exception cref="System.ArgumentNullException">The <paramref name="source" /> is null (Nothing in Visual Basic).</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">
        ...
        /// The operation was canceled before an item was received from the
        /// source.
        /// </exception>
        /// <remarks>
        /// If the source successfully offered an item that was received by this operation, it will be returned, even if a
        /// concurrent cancellation request occurs.
        /// </remarks>
        public static TOutput Receive<TOutput>(
            this ISourceBlock<TOutput> source, CancellationToken cancellationToken)
        {
        ...
        /// <remarks>
        /// If the source successfully offered an item that was received by this operation, it will be returned, even if a
        /// concurrent timeout or cancellation request occurs.
        /// </remarks>
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        static Task<TOutput> ReceiveCore<TOutput>(
            this ISourceBlock<TOutput> source, bool attemptTryReceive, TimeSpan timeout, CancellationToken cancellationToken)
        {
            ...
            if (attemptTryReceive)
            {
                ...
                if (receivableSource != null)
                {
                    try
                    {
                        ...
                        {
                            return Task.FromResult(fastCheckedItem);
                        }
                    }
                    catch (Exception exc)
                    {
            ...
            return ReceiveCoreByLinking(source, millisecondsTimeout, cancellationToken);
        }
        ...
        static readonly Action<object> _cancelCts = state => ((CancellationTokenSource) state).Cancel();
        ...
        [DebuggerDisplay("{DebuggerDisplayContent,nq}")]
        sealed class ReceiveTarget<T> : TaskCompletionSource<T>, ITargetBlock<T>, IDebuggerDisplay
        {
            ...
            object DebuggerDisplayContent
            {
                get { return $"{Common.GetNameForDebugger(this)} IsCompleted={Task.IsCompleted}"; }
            }
            ...
            DataflowMessageStatus ITargetBlock<T>.OfferMessage(DataflowMessageHeader messageHeader, T messageValue, ISourceBlock<T> source, bool consumeToAccept)
            {
                ...
                {
                    throw new ArgumentException("consumeToAccept");
                }
                Contract.EndContractBlock();
            ...
            {
                Common.ContractAssertMonitorStatus(IncomingLock, false);
                ...
                switch (reason)
                {
                    ...
                    case ReceiveCoreByLinkingCleanupReason.Success:
                        Tasks.Task.Factory.StartNew(state =>
                        {
                    ...
                    case ReceiveCoreByLinkingCleanupReason.ErrorDuringCleanup:
                        ...
                        Tasks.Task.Factory.StartNew(state =>
                        {
                            ...
                            try
                            {
                                target.TrySetException(target._receivedException ?? new Exception());
                            }
                            catch (ObjectDisposedException)
                            {
                                /* benign race if returned task is already disposed */
            ...
            {
                return Common.InitializeStackTrace(new InvalidOperationException());
            }
            ...
            /// <remarks>
            /// The C# compiler will not cache this delegate by default due to it being a generic method on a non-generic
            /// class.
            /// </remarks>
            ...
            /// <summary>
            /// Cached delegate used in ReceiveCoreByLinking on the cancellation token. Passed the ReceiveTarget as the state
            /// argument.
            /// </summary>
            /// <remarks>
            /// The C# compiler will not cache this delegate by default due to it being a generic method on a non-generic
        ...
        /// more output is available.  When the task completes, if its <see cref="System.Threading.Tasks.Task{Boolean}.Result" />
        /// is true, more output
        ...
        [DebuggerDisplay("{DebuggerDisplayContent,nq}")]
        sealed class OutputAvailableAsyncTarget<T> : TaskCompletionSource<bool>, ITargetBlock<T>, IDebuggerDisplay
        {
            /// <summary>The data to display in the debugger display attribute.</summary>
            [SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider")]
            object DebuggerDisplayContent
            ...
            static void CancelAndUnlink(object state)
            {
                ...
                Tasks.Task.Factory.StartNew(tgt =>
                {
        ...
        sealed class EncapsulatingPropagator<TInput, TOutput> : IPropagatorBlock<TInput, TOutput>, IReceivableSourceBlock<TOutput>, IDebuggerDisplay
        {
            ...
            ISourceBlock<TOutput> _source;

            /// <summary>The target half.</summary>
            ITargetBlock<TInput> _target;
        ...
        /// the task will end in the <see cref="System.Threading.Tasks.TaskStatus.Faulted" /> state containing the unhandled
        /// exception, otherwise the task
        ...
        /// The <paramref name="dataflowBlockOptions" /> is null (Nothing in Visual
        /// Basic).
        /// </exception>
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope")]
        public static Task<int> Choose<T1, T2>(
        ...
        /// <summary>
        /// Monitors three dataflow sources, invoking the provided handler for whichever source makes data available
        /// first.
        /// </summary>
        /// <typeparam name="T1">Specifies type of data contained in the first source.</typeparam>
        /// <typeparam name="T2">Specifies type of data contained in the second source.</typeparam>
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope")]
        static Task<int> ChooseCore<T1, T2, T3>(
            ISourceBlock<T1> source1, Action<T1> action1,
            ISourceBlock<T2> source2, Action<T2> action2,
            ISourceBlock<T3> source3, Action<T3> action3,
            DataflowBlockOptions dataflowBlockOptions)
        {
            ...
            var hasThirdSource = source3 != null; // In the future, if we want higher arities on Choose, we can simply add more such checks on additional arguments
        ...
        static bool TryChooseFromSource<T>(
            ...
            out Task<int> task)
        {
            ...
            task = Task.Factory.StartNew(ChooseTarget<T>.s_processBranchFunction,
                Tuple.Create(action, result, branchId),
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope")]
        static Task<int> ChooseCoreByLinking<T1, T2, T3>(
            ISourceBlock<T1> source1, Action<T1> action1,
            ISourceBlock<T2> source2, Action<T2> action2,
            ISourceBlock<T3> source3, Action<T3> action3,
            DataflowBlockOptions dataflowBlockOptions)
                ...
                foreach (var task in tasks)
                {
                    switch (task.Status)
                    {
                        case TaskStatus.Faulted:
                            Common.AddException(ref exceptions, task.Exception, true);
                            break;
                        case TaskStatus.RanToCompletion:
                            var resultBranchId = task.Result;
                            if (resultBranchId >= 0)
                            {
                            ...
                            {
                                Debug.Assert(resultBranchId == -1, "Expected -1 as a signal of a non-successful branch");
                            }
                            break;
                    }
                }
        ...
        /// <param name="boxedCompleted">
        /// A strong box around the completed Task from any target. Also sync obj for access to the
        /// targets.
        /// </param>
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        static Task<int> CreateChooseBranch<T>(
        ...
        [DebuggerDisplay("{DebuggerDisplayContent,nq}")]
        sealed class ChooseTarget<T> : TaskCompletionSource<T>, ITargetBlock<T>, IDebuggerDisplay
        {
            ...
            internal ChooseTarget(StrongBox<Task> completed, CancellationToken cancellationToken)
            {
                ...
                Common.WireCancellationToComplete(cancellationToken, Task,
                    state =>
                    {
            ...
            public DataflowMessageStatus OfferMessage(DataflowMessageHeader messageHeader, T messageValue, ISourceBlock<T> source, bool consumeToAccept)
            {
                ...
                lock (_completed)
                {
                    ...
                    if (_completed.Value != null || Task.IsCompleted)
                    {
                        return DataflowMessageStatus.DecliningPermanently;
                    }
            ...
            {
                var actionResultBranch = (Tuple<Action<T>, T, int>) state;
        ...
        /// <summary>
        /// Creates a new <see cref="System.IObservable{TOutput}" /> abstraction over the
        /// <see cref="ISourceBlock{TOutput}" />.
        /// </summary>
        /// <typeparam name="TOutput">Specifies the type of data contained in the source.</typeparam>
        ...
        static readonly ExecutionDataflowBlockOptions _nonGreedyExecutionOptions = new ExecutionDataflowBlockOptions
        {
            BoundedCapacity = 1
        };
        ...
        sealed class SourceObservable<TOutput> : IObservable<TOutput>, IDebuggerDisplay
        {
            ...
            IDisposable IObservable<TOutput>.Subscribe(IObserver<TOutput> observer)
            {
                ...
                Contract.EndContractBlock();
                Common.ContractAssertMonitorStatus(_SubscriptionLock, false);
            ...
            ImmutableList<IObserver<TOutput>> ResetObserverState()
            {
                Common.ContractAssertMonitorStatus(_SubscriptionLock, true);
            ...
            sealed class ObserversState
            {
                ...
                [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
                Task ProcessItemAsync(TOutput item)
                {
                    Common.ContractAssertMonitorStatus(Observable._SubscriptionLock, false);
                ...
                /// </param>
                [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
                void NotifyObserversOfCompletion(Exception targetException = null)
                {
                ...
                /// </summary>
                List<Task<bool>> _tempSendAsyncTaskList;
        ...
        /// <summary>
        /// Creates a new <see cref="System.IObserver{TInput}" /> abstraction over the <see cref="ITargetBlock{TInput}" />
        /// .
        /// </summary>
        ...
        /// <returns>
        /// A <see cref="T:System.Threading.Tasks.Dataflow.ITargetBlock`1" /> that accepts and subsequently drops all
        /// offered messages.
        /// </returns>
