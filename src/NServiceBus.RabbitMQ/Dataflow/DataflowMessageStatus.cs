...
namespace System.Threading.Tasks.Dataflow
{
    ...
    public enum DataflowMessageStatus
    {
        ...
        /// <summary>
        /// Indicates that the <see cref="ITargetBlock{TInput}" /> declined the message.  The <see cref="ISourceBlock{TOutput}" />
        ...
        /// <summary>
        /// Indicates that the <see cref="ITargetBlock{TInput}" /> tried to accept the message from the
        /// <see cref="ISourceBlock{TOutput}" />, but the
