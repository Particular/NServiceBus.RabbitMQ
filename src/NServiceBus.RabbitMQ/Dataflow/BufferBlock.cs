...
namespace System.Threading.Tasks.Dataflow
{
    ...
    sealed class BufferBlock<T> : IPropagatorBlock<T, T>, IReceivableSourceBlock<T>, IDebuggerDisplay
    {
        ...
        /// <summary>
        /// Gets the number of messages in the buffer.  This must only be used from the debugger as it avoids taking
        /// necessary locks.
        /// </summary>
        int CountForDebugger
        {
        ...
        object DebuggerDisplayContent => $"{Common.GetNameForDebugger(this, _source.DataflowBlockOptions)}, Count={CountForDebugger}";
        ...
        internal void ConsumeAsyncIfNecessary(bool isReplacementReplica = false)
        {
                ...
                _boundingState.CountIsLessThanBound)
            {
                ...
                if (exception != null)
                {
                    ...
                    Task.Factory.StartNew(exc => CompleteCore((Exception) exc, true, true),
        ...
        sealed class DebugView
        {
            ...
            {
                get { return _bufferBlock._boundingState != null ? _bufferBlock._boundingState.TaskForInputProcessing : null; }
            }
