...
namespace System.Threading.Tasks.Dataflow.Internal
{
    ...
    [StructLayout(LayoutKind.Explicit, Size = Padding.CACHE_LINE_SIZE - sizeof(int))] // Based on common case of 64-byte cache lines
    struct PaddingForInt32
    {
    }
    ...
    struct PaddedInt64
    {
        [FieldOffset(Padding.CACHE_LINE_SIZE)] internal long Value;
    }
}